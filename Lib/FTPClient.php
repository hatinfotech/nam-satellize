...
class FTPClient implements FTPClient_FTPClientInterface,
    FTPClient_ObservableInterface {
    /** @var resource */
    protected $connection = null;
    protected $timeout = 90;
    protected $transferMode = null;

    /** @var FTPClient_ObserverInterface */
    ...
    public function upload($localFilename, $remoteFilename, $mode = 2, $startPosition = 0) {
        ...
        while (feof($localFilePointer) === false) {
            ...
            echo "\n";
            $result = fwrite($dataConnection, fread($localFilePointer, 10240), 10240);
            echo "fwrite result : $result\n";
        }
